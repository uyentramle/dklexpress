  ...
  <div class="module">
    ...
    <fieldset>
      <p>
        ...
        <input name="data[ten]" id="ten" class="input-short" />
      </p>
      <p>
        <label style="font-weight:bold">Thông Tin</label>
        <textarea class="input-long" id="thong_tin" name="data[thong_tin]" rows="18"></textarea>
        <script>
		  CKEDITOR.replace( 'thong_tin' );
		</script> 
      </p>
      <p>
      	<input type="hidden" name="data[ngay_tao]" />
        <label style="font-weight:bold">Ngày Xuất Bản</label>
        <input class="input-short" type="text" id="ngay_xuat_ban" name="data[ngay_xuat_ban]">
        <input type="hidden" name="data[ma_nguoi_tao]" />
        {literal} 
        <script>
          $(function() {
