...
try{
	...
	$ds_thong_tin_chuyen_thu = $dt_xl_thong_tin_chuyen_thu->danh_sach_theo_so_hieu($so_hieu);
	$dt_smarty->assign('ds_thong_tin_chuyen_thu', $ds_thong_tin_chuyen_thu);
	...
	$contentForLayout = $dt_smarty->fetch('info/add.tpl');
